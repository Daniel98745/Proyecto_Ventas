...
class Productos : AppCompatActivity() {
    ...
    fun cargarR(){
        txtNomProd = findViewById(R.id.txtNombreProducto)
        txtPrecioProd = findViewById(R.id.txtPrecioProducto)
        txtCodProd = findViewById(R.id.txtCodProducto)
        btnRegProd = findViewById(R.id.btnRegistrarProd)
    }
    fun estadoBoton(){
